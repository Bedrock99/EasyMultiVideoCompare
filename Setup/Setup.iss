...
#define MyAppName "EasyMultiVideoCompare"
#define MyAppVersion "1.0"
#define MyAppPublisher "Bedrock99"
#define MyAppURL "https://github.com/Bedrock99/EasyMultiVideoCompare"
#define MyAppExeName "EasyMultiVideoCompare.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{4670314F-D372-4BB9-BA05-BCFBE6264DDB}
AppName={#MyAppName}
...
OutputDir=Output
OutputBaseFilename=EasyMultiVideoCompare_Setup
Compression=lzma
