...
namespace DarkModeForms
{
	...
	public static class Messenger
	{
		...
		{
			Size sz = TextRenderer.MeasureText(Message, SystemFonts.DefaultFont);
			...
			foreach (var _button in CmdButtons)
			{
				...
				using (Graphics g = form.CreateGraphics())
				{
					...
					_button.Size = new Size(120, systemFont.Height + 10); // Adding some padding
				}
			...
			Rectangle picBox = new Rectangle(10, 10, 0, 0);
            ...
            int height = bottomPanel.Height + sz.Height + 50;
			...
			if (bCut)
			{
                lblPrompt = new Label
                {
                    ...
                    MaximumSize = new Size(form.ClientSize.Width - (picBox.X + picBox.Width) - 16, 0),
                    MinimumSize = new Size(form.ClientSize.Width - (picBox.X + picBox.Width) - 16, 64),
                };
                lblPrompt.BringToFront();
				...
				{
					Location = new Point(picBox.X + picBox.Width + 4, picBox.Y),
					Size = new Size(lblPrompt.Width + 20, height - bottomPanel.Height - 20),
					AutoScroll = true,
			...
			else
			{
                ...
                form.ClientSize = new Size(width,
                bottomPanel.Height +
                lblPrompt.Height +
                20
            );
